 ...
 */
public class MyspaceButton extends ZocialButton
{
    public MyspaceButton()
    {
        setStyleName(ZocialButtonResources.INSTANCE.zocial().zocial());
        addStyleName(ZocialButtonResources.INSTANCE.zocial().myspace());
        setText("Find me on Myspace");
    }
}
