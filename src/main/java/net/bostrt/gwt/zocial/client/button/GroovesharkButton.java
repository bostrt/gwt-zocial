 ...
 */
public class GroovesharkButton extends ZocialButton
{
    public GroovesharkButton()
    {
        setStyleName(ZocialButtonResources.INSTANCE.zocial().zocial());
        addStyleName(ZocialButtonResources.INSTANCE.zocial().grooveshark());
        setText("Play on Grooveshark");
    }
}
