 ...
 */
public class BitbucketButton extends ZocialButton
{
    public BitbucketButton()
    {
        setStyleName(ZocialButtonResources.INSTANCE.zocial().zocial());
        addStyleName(ZocialButtonResources.INSTANCE.zocial().bitbucket());
        setText("Fork from Bitbucket");
    }
}
