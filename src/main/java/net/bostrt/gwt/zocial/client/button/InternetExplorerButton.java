 ...
 */
public class InternetExplorerButton extends ZocialButton
{
    public InternetExplorerButton()
    {
        setStyleName(ZocialButtonResources.INSTANCE.zocial().zocial());
        addStyleName(ZocialButtonResources.INSTANCE.zocial().ie());
        setText("Download Internet Explorer");
    }
}
