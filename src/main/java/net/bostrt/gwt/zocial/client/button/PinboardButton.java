 ...
 */
public class PinboardButton extends ZocialButton
{
    public PinboardButton()
    {
        setStyleName(ZocialButtonResources.INSTANCE.zocial().zocial());
        addStyleName(ZocialButtonResources.INSTANCE.zocial().pinboard());
        setText("Bookmark with Pinboard");
    }
}
