 ...
 */
public class PlancastButton extends ZocialButton
{
    public PlancastButton()
    {
        setStyleName(ZocialButtonResources.INSTANCE.zocial().zocial());
        addStyleName(ZocialButtonResources.INSTANCE.zocial().plancast());
        setText("Follow me on Plancast");
    }
}
