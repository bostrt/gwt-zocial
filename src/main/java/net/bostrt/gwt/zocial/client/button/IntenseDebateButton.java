 ...
 */
public class IntenseDebateButton extends ZocialButton
{
    public IntenseDebateButton()
    {
        setStyleName(ZocialButtonResources.INSTANCE.zocial().zocial());
        addStyleName(ZocialButtonResources.INSTANCE.zocial().intensedebate());
        setText("Sign in with IntenseDebate");
    }
}
