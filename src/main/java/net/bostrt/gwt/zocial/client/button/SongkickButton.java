 ...
 */
public class SongkickButton extends ZocialButton
{
    public SongkickButton()
    {
        setStyleName(ZocialButtonResources.INSTANCE.zocial().zocial());
        addStyleName(ZocialButtonResources.INSTANCE.zocial().songkick());
        setText("Sign in with Songkick");
    }
}
