 ...
 */
public class EventfulButton extends ZocialButton
{
    public EventfulButton()
    {
        setStyleName(ZocialButtonResources.INSTANCE.zocial().zocial());
        addStyleName(ZocialButtonResources.INSTANCE.zocial().eventful());
        setText("Find Events on Eventful");
    }
}
