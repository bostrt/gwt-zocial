 ...
 */
public class EventbriteButton extends ZocialButton
{
    public EventbriteButton()
    {
        setStyleName(ZocialButtonResources.INSTANCE.zocial().zocial());
        addStyleName(ZocialButtonResources.INSTANCE.zocial().eventbrite());
        setText("Sign in with Eventbrite");
    }
}
