 ...
 */
public class SoundcloudButton extends ZocialButton
{
    public SoundcloudButton()
    {
        setStyleName(ZocialButtonResources.INSTANCE.zocial().zocial());
        addStyleName(ZocialButtonResources.INSTANCE.zocial().soundcloud());
        setText("Follow me on Soundcloud");
    }
}
