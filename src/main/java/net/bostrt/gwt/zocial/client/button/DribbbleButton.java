 ...
 */
public class DribbbleButton extends ZocialButton
{
    public DribbbleButton()
    {
        setStyleName(ZocialButtonResources.INSTANCE.zocial().zocial());
        addStyleName(ZocialButtonResources.INSTANCE.zocial().dribbble());
        setText("Sign in with Dribbble");
    }
}
