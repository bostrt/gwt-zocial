 ...
 */
public class PinterestButton extends ZocialButton
{
    public PinterestButton()
    {
        setStyleName(ZocialButtonResources.INSTANCE.zocial().zocial());
        addStyleName(ZocialButtonResources.INSTANCE.zocial().pinterest());
        setText("Follow me on Pintrest");
    }
}
