 ...
 */
public class WordPressButton extends ZocialButton
{
    public WordPressButton()
    {
        setStyleName(ZocialButtonResources.INSTANCE.zocial().zocial());
        addStyleName(ZocialButtonResources.INSTANCE.zocial().wordpress());
        setText("Sign in with WordPress");
    }
}
