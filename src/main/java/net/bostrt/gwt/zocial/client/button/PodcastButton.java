 ...
 */
public class PodcastButton extends ZocialButton
{
    public PodcastButton()
    {
        setStyleName(ZocialButtonResources.INSTANCE.zocial().zocial());
        addStyleName(ZocialButtonResources.INSTANCE.zocial().podcast());
        setText("Subscribe to this Podcast");
    }
}
