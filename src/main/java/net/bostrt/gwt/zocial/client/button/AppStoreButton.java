 ...
 */
public class AppStoreButton extends ZocialButton
{
    public AppStoreButton()
    {
        setStyleName(ZocialButtonResources.INSTANCE.zocial().zocial());
        addStyleName(ZocialButtonResources.INSTANCE.zocial().appstore());
        setText("Available on App Store");
    }
}
