 ...
 */
public class StackOverflowButton extends ZocialButton
{
    public StackOverflowButton()
    {
        setStyleName(ZocialButtonResources.INSTANCE.zocial().zocial());
        addStyleName(ZocialButtonResources.INSTANCE.zocial().stackoverflow());
        setText("Sign in with Stack Overflow");
    }
}
