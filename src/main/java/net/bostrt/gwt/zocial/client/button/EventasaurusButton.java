 ...
 */
public class EventasaurusButton extends ZocialButton
{
    public EventasaurusButton()
    {
        setStyleName(ZocialButtonResources.INSTANCE.zocial().zocial());
        addStyleName(ZocialButtonResources.INSTANCE.zocial().eventasaurus());
        setText("Sign up for Eventasaurus");
    }
}
