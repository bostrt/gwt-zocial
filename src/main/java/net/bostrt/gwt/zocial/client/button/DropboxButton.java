 ...
 */
public class DropboxButton extends ZocialButton
{
    public DropboxButton()
    {
        setStyleName(ZocialButtonResources.INSTANCE.zocial().zocial());
        addStyleName(ZocialButtonResources.INSTANCE.zocial().dropbox());
        setText("Sync with Dropbox");
    }
}
