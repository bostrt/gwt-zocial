 ...
 */
public class AndroidMarketButton extends ZocialButton
{
    public AndroidMarketButton()
    {
        setStyleName(ZocialButtonResources.INSTANCE.zocial().zocial());
        addStyleName(ZocialButtonResources.INSTANCE.zocial().android());
        setText("Available on Android Market");
    }
}
