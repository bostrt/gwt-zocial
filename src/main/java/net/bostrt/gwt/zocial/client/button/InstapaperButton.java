 ...
 */
public class InstapaperButton extends ZocialButton
{
    public InstapaperButton()
    {
        setStyleName(ZocialButtonResources.INSTANCE.zocial().zocial());
        addStyleName(ZocialButtonResources.INSTANCE.zocial().instapaper());
        setText("Read It Later");
    }
}
