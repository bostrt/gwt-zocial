 ...
 */
public class AngelListButton extends ZocialButton
{
    public AngelListButton()
    {
        setStyleName(ZocialButtonResources.INSTANCE.zocial().zocial());
        addStyleName(ZocialButtonResources.INSTANCE.zocial().angellist());
        setText("Fund us on AngelList");
    }
}
