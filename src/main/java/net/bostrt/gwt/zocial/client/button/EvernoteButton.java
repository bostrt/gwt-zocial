 ...
 */
public class EvernoteButton extends ZocialButton
{
    public EvernoteButton()
    {
        setStyleName(ZocialButtonResources.INSTANCE.zocial().zocial());
        addStyleName(ZocialButtonResources.INSTANCE.zocial().evernote());
        setText("Clip to Evernote");
    }
}
