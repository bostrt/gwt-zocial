 ...
 */
public class MacAppStoreButton extends ZocialButton
{
    public MacAppStoreButton()
    {
        setStyleName(ZocialButtonResources.INSTANCE.zocial().zocial());
        addStyleName(ZocialButtonResources.INSTANCE.zocial().macstore());
        setText("Available on Mac App Store");
    }
}
